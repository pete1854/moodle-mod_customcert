...
$string['bid_teacher_must_sign'] = 'Kräv signatur från handledare';
$string['bid_teacher_must_sign_help'] = 'Handledaren måste signera intyget innan det kan utfärdas.';
$string['bid_student_must_sign'] = 'Kräv signatur från kursdeltagare';
$string['bid_student_must_sign_help'] = 'Kursdeltagaren måste signera intyget innan det kan utfärdas.';
...
$string['modulename'] = 'Intyg';
$string['modulenameplural'] = 'Intyg';
...
$string['page'] = 'Page {$a}';
$string['pluginadministration'] = 'Administration av intyg';
$string['pluginname'] = 'Intyg';
