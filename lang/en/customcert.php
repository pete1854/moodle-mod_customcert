...
$string['customcert:managebidsupport'] = 'Manage BID settings';
...
$string['bidsupport'] = 'Sign using BankID';
$string['bidsupport_help'] = 'If set certificate will support BID.';
$string['bid_teacher_must_sign'] = 'Teacher signature required';
$string['bid_teacher_must_sign_help'] = 'The teacher signature is required for allowing the certificate to be completed.';
$string['bid_student_must_sign'] = 'Studentsignature required';
$string['bid_student_must_sign_help'] = 'The student signature is required for allowing the certificate to be completed.';
